 ...
 * benchmark, over a fixed set of trailing windows.
 *
 * Query: ?ticker=AAPL&benchmark=SPY&period=1Y
 *   period ∈ 3M | YTD | 1Y | 3Y | 5Y | 10Y   (default 1Y)
...
import { buildChart, PERIODS, PERIOD_LABEL, type PeriodKey } from "../lib/charts/prices";
